...
- 2026-08-27 — C2C3 failures now route through `GlobalExceptionHandler`; success bodies unchanged. Closes finding 40, downgrades 42. Tests 41 → 50.

- 2026-08-27 — Added the C2C3 module (Category I import, Category III summary) and renamed packages to match the certification criteria: `QRDA` → `C1`, `C2` → `C2C3`. Endpoints 31 → 33, EHR DTOs 62 → 65, findings 38 → 47.
