...
| [patterns.md](patterns.md) | Layering, error handling, C2C3's raw success bodies, transaction boundaries, date/zone handling, CDA construction, measure definitions, testing |
