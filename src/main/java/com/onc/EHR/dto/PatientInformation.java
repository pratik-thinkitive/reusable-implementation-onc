...
public class PatientInformation {
    ...
    /**
     * Multi-valued: a patient may report more than one race. The shared ObjectMapper enables
     * ACCEPT_SINGLE_VALUE_AS_ARRAY, so this binds whether the API sends a scalar or an array.
     */
    @JsonProperty("race_with_more_granular_race_code")
    private List<String> race;

    /** Multi-valued for the same reason as {@link #race}. */
